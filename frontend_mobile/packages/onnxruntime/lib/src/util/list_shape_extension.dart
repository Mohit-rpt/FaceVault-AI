...
extension ListShape on List {
  ...
  List<T> flatten<T>() {
    // Fast path: if this is already a flat typed-data array, return directly.
    // This avoids iterating 1M+ elements through forEach+add for TypedData.
    if (this is Float32List) return this as List<T>;
    if (this is Float64List) return this as List<T>;
    if (this is Uint8List) return this as List<T>;
    if (this is Int8List) return this as List<T>;
    if (this is Uint16List) return this as List<T>;
    if (this is Int16List) return this as List<T>;
    if (this is Uint32List) return this as List<T>;
    if (this is Int32List) return this as List<T>;
    if (this is Uint64List) return this as List<T>;
    if (this is Int64List) return this as List<T>;
